...
oceanpayment WeChatPay payment  plugin

== Description ==
oceanpayment WeChatPay payment  plugin

== Installation ==
1.install the Oceanpayment-WeChatPay plug-in in the WordPrwss background.
2.Activate oceanpayment WeChatPay in the plugin menu.
